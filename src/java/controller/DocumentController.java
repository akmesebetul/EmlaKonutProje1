...
public class DocumentController extends BaseBean implements Serializable, Validator {
    ...
    private final String uploadTo = "C:\\Users\\tr\\Documents\\NetBeansProject\\EmlaKonutProje1\\upload\\";
    ...
    public void upload() {
        try {
            ...
            File f;
            f = new File(uploadTo + doc.getHeader(uploadTo));
            ...
            File newFile = new File("C:\\Users\\tr\\Documents\\NetBeansProject\\EmlaKonutProje1\\upload\\" + a + "." + extension);
            f.renameTo(newFile);
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        if (partObject != null) {
            if (partObject.getSize() > 10000000) {
                throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, " maksimum 10 megabyte", " maksimum 10 megabyte"));
            }
